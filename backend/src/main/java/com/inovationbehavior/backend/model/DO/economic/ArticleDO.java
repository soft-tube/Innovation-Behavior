...
public class ArticleDO {
    ...
    String url;
    String type;
    List<AuthorDO> authors;

    public ArticleDO(String titleEn, String titleZn, String titleDe, String abstractEn, String abstractZn, String abstractDe, String url, String type) {
