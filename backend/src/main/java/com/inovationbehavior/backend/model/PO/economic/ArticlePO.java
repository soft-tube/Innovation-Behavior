...
public class ArticlePO {
    ...
    String url;
    String type;
    List<AuthorPO> authors;

    public ArticlePO(String titleEn, String titleZn, String titleDe, String abstractEn, String abstractZn, String abstractDe, String url, String type) {
