<template>
    <el-card style="border-radius: 15px;width: 100%;">
        ...
        <el-form :model="form" size="large" label-position="top">
            <el-form-item class="question" style="font-weight: bolder;" label="D01.您所在课题组为什么申请该专利？">
            ...
            <el-form-item class="question" style="font-weight: bolder;" label="D02.过去三年，您（或所在高校）是否为该专利技术进行过以下宣传推广？">
            ...
            <el-form-item class="question" style="font-weight: bolder;" label="D03.对于该专利，是否已经达成了许可交易？">
            ...
            <el-form-item class="question" v-if="showPDQ03" style="font-weight: bolder;" label="D0302.贵校对外许可该专利的目的是什么？">
            ...
            <el-form-item class="question" v-if="showPDQ03" style="font-weight: bolder;" label="D0303.贵校对外许可的企业类型是？">
            ...
            <el-form-item class="question" v-if="showPDQ03" style="font-weight: bolder;" label="D0304.贵校对外许可的企业规模是？">
            ...
            <el-form-item class="question" style="font-weight: bolder;" label="D05.未来三年，您（或所在高校）是尝试对外许可该专利？">
            ...
            <el-form-item class="question" style="font-weight: bolder;" label="D06.未来三年，您（或所在高校）对该专利是否有其他商业化计划？">
